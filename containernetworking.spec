...
install -Dpm755 -t %{buildroot}%{_exec_prefix}/sbin bin/cnitool
install -Dpm755 -t %{buildroot}/opt/cni/bin bin/noop
install -Dpm755 -t %{buildroot}/opt/cni/bin bin/sleep

%files
%license LICENSE
%doc 99-loopback.conf
%dir %{_sysconfdir}/cni
